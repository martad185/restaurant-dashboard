...
export default async function SalesPortalPage() {
    ...
    // Fetch restaurants linked to this user + their sales for today
    ...
    return (
        <main className="p-8 max-w-5xl mx-auto space-y-8 min-h-screen bg-gray-50">
            <header className="flex justify-between items-end">
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Select Store</h1>                    
                </div>                
            </header>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-10">
                                <div className="text-right">
                                    <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest mb-1">Today Gross</p>
