...
export default async function SelectDayPage({
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#E5E5E5]">
            ...
            <header className="bg-[#F3F3F3] border-b border-gray-300 py-4 sticky top-0 z-10">{/*className="bg-white border-b border-gray-300 px-4 py-3 flex items-center gap-4 sticky top-0 z-10">*/}
                <div className="max-w-4xl mx-auto bg-white py-4 flex items-center gap-4">
