...
export default async function SelectDayPage({
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#E5E5E5]">
            ...
            <header className="sticky top-0 z-05 w-full border-b border-gray-200">{/*className="bg-white border-b border-gray-300 px-4 py-3 flex items-center gap-4 sticky top-0 z-10">*/}
